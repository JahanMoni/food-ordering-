	...
	<div class="menu-box">
		<div class="container">
			...
			<div class="row special-list">
				...
				<div class="col-lg-4 col-md-6 special-grid lunch">
					<div class="gallery-single fix">
						<img src="{{url('/frontend/images/img-05.jpg')}}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid lunch">
					<div class="gallery-single fix">
						<img src="{{url('/frontend/images/img-06.jpg')}}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid dinner">
					<div class="gallery-single fix">
						<img src="{{url('/frontend/images/img-07.jpg')}}" class="img-fluid" alt="Image">
						<div class="why-text">
				...
				<div class="col-lg-4 col-md-6 special-grid dinner">
					<div class="gallery-single fix">
						<img src="a{{url('/frontend/images/img-08.jpg')}}" class="img-fluid" alt="Image">
						<div class="why-text">
